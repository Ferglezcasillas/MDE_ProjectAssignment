 ...
 * </p>
 * <ul>
 *   <li>{@link structureAndBehaviour.impl.PrimativeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimativeImpl extends VariableImpl implements Primative {
	...
	protected EClass eStaticClass() {
		return StructureAndBehaviourPackage.Literals.PRIMATIVE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructureAndBehaviourPackage.PRIMATIVE__TYPE, oldType,
					type));
	}
