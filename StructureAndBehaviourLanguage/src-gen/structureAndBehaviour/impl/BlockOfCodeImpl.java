 ...
 * </p>
 * <ul>
 *   <li>{@link structureAndBehaviour.impl.BlockOfCodeImpl#getThings <em>Things</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockOfCodeImpl extends MinimalEObjectImpl.Container implements BlockOfCode {
	...
	protected EClass eStaticClass() {
		return StructureAndBehaviourPackage.Literals.BLOCK_OF_CODE;
	}
	...
	public EList<generalItem> getThings() {
		if (things == null) {
			things = new EObjectContainmentEList<generalItem>(generalItem.class, this,
					StructureAndBehaviourPackage.BLOCK_OF_CODE__THINGS);
		}
		return things;
	}
