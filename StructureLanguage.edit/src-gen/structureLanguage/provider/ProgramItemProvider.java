...
/**
 * This is the item provider adapter for a {@link structureLanguage.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						StructureLanguagePackage.Literals.PROGRAM__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructureLanguagePackage.Literals.PROGRAM__CLASS);
			childrenFeatures.add(StructureLanguagePackage.Literals.PROGRAM__INTERFACE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case StructureLanguagePackage.PROGRAM__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case StructureLanguagePackage.PROGRAM__CLASS:
		case StructureLanguagePackage.PROGRAM__INTERFACE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StructureLanguagePackage.Literals.PROGRAM__CLASS,
				StructureLanguageFactory.eINSTANCE.createClass()));

		newChildDescriptors.add(createChildParameter(StructureLanguagePackage.Literals.PROGRAM__INTERFACE,
				StructureLanguageFactory.eINSTANCE.createInterface()));
	}
