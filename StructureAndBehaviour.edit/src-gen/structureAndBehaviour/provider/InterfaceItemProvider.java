...
/**
 * This is the item provider adapter for a {@link structureAndBehaviour.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Interface_name_feature",
								"_UI_Interface_type"),
						StructureAndBehaviourPackage.Literals.INTERFACE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructureAndBehaviourPackage.Literals.INTERFACE__METHOD);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case StructureAndBehaviourPackage.INTERFACE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case StructureAndBehaviourPackage.INTERFACE__METHOD:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StructureAndBehaviourPackage.Literals.INTERFACE__METHOD,
