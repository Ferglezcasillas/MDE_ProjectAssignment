...
/**
 * This is the item provider adapter for a {@link structureAndBehaviour.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Function_name_feature",
								"_UI_Function_type"),
						StructureAndBehaviourPackage.Literals.FUNCTION__NAME, true, false, false,
	...
	protected void addAccessTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_accessType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_accessType_feature",
								"_UI_Function_type"),
						StructureAndBehaviourPackage.Literals.FUNCTION__ACCESS_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addParametersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_parameters_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_parameters_feature",
								"_UI_Function_type"),
						StructureAndBehaviourPackage.Literals.FUNCTION__PARAMETERS, true, false, true, null, null,
						null));
	}
	...
	protected void addReturnPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_return_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_return_feature",
								"_UI_Function_type"),
						StructureAndBehaviourPackage.Literals.FUNCTION__RETURN, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructureAndBehaviourPackage.Literals.FUNCTION__BLOCKOFCODE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StructureAndBehaviourPackage.Literals.FUNCTION__BLOCKOFCODE,
				StructureAndBehaviourFactory.eINSTANCE.createBlockOfCode()));
	}
