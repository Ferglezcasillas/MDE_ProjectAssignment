...
/**
 * This is the item provider adapter for a {@link structureAndBehaviour.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						StructureAndBehaviourPackage.Literals.CLASS__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						StructureAndBehaviourPackage.Literals.CLASS__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Class_accessType_feature",
								"_UI_Class_type"),
						StructureAndBehaviourPackage.Literals.CLASS__ACCESS_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Class_inherated_feature",
								"_UI_Class_type"),
						StructureAndBehaviourPackage.Literals.CLASS__INHERATED, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Class_implements_feature",
								"_UI_Class_type"),
						StructureAndBehaviourPackage.Literals.CLASS__IMPLEMENTS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructureAndBehaviourPackage.Literals.CLASS__VARIABLE);
			childrenFeatures.add(StructureAndBehaviourPackage.Literals.CLASS__METHOD);
		}
	...
	public String getText(Object object) {
		String label = ((structureAndBehaviour.Class) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(structureAndBehaviour.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StructureAndBehaviourPackage.Literals.CLASS__VARIABLE,
		...
		newChildDescriptors.add(createChildParameter(StructureAndBehaviourPackage.Literals.CLASS__METHOD,
				StructureAndBehaviourFactory.eINSTANCE.createFunction()));
	}
